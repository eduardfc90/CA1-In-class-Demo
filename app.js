...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('ZaraShop.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('ZaraShop.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('ZaraShop.xml', function(err, result) {
      if (err) throw (err);
      ...
      jsToXmlFile('ZaraShop.xml', result, function(err) {
